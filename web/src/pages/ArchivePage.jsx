  ...
  return (
    <div className="max-w-4xl mx-auto px-12 py-16">
      <div className="flex justify-between items-end mb-12">
        <div>
          <h2 className="font-headline text-5xl font-bold tracking-tight text-on-surface mb-2">Archived</h2>
          <p className="text-outline text-lg">Review past executive sessions.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-outline font-label">No archived conversations.</div>
      ) : (
